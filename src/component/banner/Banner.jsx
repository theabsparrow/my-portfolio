...
const Banner = () => {
  return (
    <>
      <section className="relative md:h-[85vh] bg-[url('/my-image.jpeg')] bg-cover bg-center bg-no-repeat flex items-start justify-end rounded-3xl overflow-hidden shadow-xl p-4 md:py-10 md:px-12">
